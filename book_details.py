...
class bookDeailsWindow:
    ...
    def book_details_window(self, mainwin):
        ...
        self.bookwin.geometry(f"{self.width}x{self.height}+{self.screen_width}+{self.screen_height}")
        ...
        self.top_label = Label(self.bookwin, image=self.photo0, bg="cyan")
        self.top_label.place(x=0, y=0, width=600, height=65)

        self.delbutton = Button(self.bookwin, text="Delete", font=("Nirmala UI", 15, 'bold'), bg="gold",
    ...
    def getimage(self, ev):
        ...
        try:
            ...
            cursor.execute(f"select book_image from book where book_isbn = '{self.info[0]}'")
    ...
    def delete_book(self):
        ...
        if self._isselected == True:
            ...
            cursor.execute(f"delete from book where book_isbn = '{self.info[0]}'")
            connection.commit()
            connection.close()
            self._isselected = False
